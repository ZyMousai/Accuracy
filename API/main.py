...
from app.OffersSystem.Offers.spider import UnionApiRun
...
master_scheduler.add_job(uar.run, "interval", days=2)
# master_scheduler.add_job(uar.run, "interval", seconds=30)

...
class Heartbeat(PBaseModel):
    ...
    create_time = BaseType.BaseColumn(BaseType.BaseDateTime, nullable=False, comment='创建时间')
    last_heartbeat = BaseType.BaseColumn(BaseType.BaseDateTime, nullable=False, comment='上次心跳时间')
    ...
    alarm = BaseType.BaseColumn(BaseType.BaseBoolean, nullable=False, comment='是否启用:0-否；1-是')
    state = BaseType.BaseColumn(BaseType.BaseBoolean, nullable=False, comment='状态:0-正常；1-异常；2-离线')
